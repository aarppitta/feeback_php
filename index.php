...
?>
    ...
    <?php 
    /* include and require both are used for including php files.
    Difference between them is if in require file is not found everything stops working.
    In include it still loads the rest of the files. 
    */
    ?>
